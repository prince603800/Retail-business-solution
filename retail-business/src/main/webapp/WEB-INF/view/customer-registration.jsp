...
<body class = "main-body">
	...
	<div class="container-fluid container-class">
            ...
            <h2>Customer Registration Form</h2>
                <form:form action="customer-registration" method = "post" modelAttribute = "customerInfo" id="second_form">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                        <form:input type="number" class="form-control" id="panNo" placeholder="Enter Shop Registration No" path="panNo"/>
                    </div>
                    <div class="form-group">
